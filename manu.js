...
// Filtrerer de viste produkter baseret på den valgte kategori. 
...
function filterSelection(category) {
  ...
  // vi tager alle elementer i dokumentet med class "drinks_item" (som er elementerne i galleriet)
  ...
  // her looper vi igennem arrayet af produkter
  for (let i = 0; i < items.length; i++) { 
    // Fjern altid "drinks_show"-klassen først for at skjule alle elementer
    ...
    // "hvis category er i lig med "drinks_alle" er true 
...
// metode der tilføjer event handlers til alle produkt filter knapper
// køre kun en gang
function initFilterButtons() {
  console.log("Initializing filter buttons."); // Så kan jeg se at den køre, når den skal  (debugging.)
  ...
  // fra btnContainer finder vi alle elementer med class name "drinks__btn"
